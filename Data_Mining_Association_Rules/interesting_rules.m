function association_rules = interesting_rules (D, frequent_itemsets, min_interest)
...
fprintf(1, '\nCalculating interest for candidate assocoation rules...');
k = 1;
for i = 1 : length(candidate_rule)
    ...
    if interest >= min_interest
        ...
        association_rules{k}.interest = interest;
        k = k + 1;
    end
end
